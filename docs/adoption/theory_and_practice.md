...
Both approaches should always be based on clear reference documentation (see [Single Source of Truth pattern](../patterns/documentation.md#single-source-of-truth)).
