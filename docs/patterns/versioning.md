...
For example, the published OCDS documentation has versions on different MAJOR.MINOR [branches](https://github.com/open-contracting/standard/branches/all) (e.g. https://standard.open-contracting.org/1.0/en/), whereas the published OCDS schema has versions on different MAJOR__MINOR__PATCH [tagged releases](https://github.com/open-contracting/standard/tags) (e.g. https://standard.open-contracting.org/schema/1__0__1/release-schema.json).
