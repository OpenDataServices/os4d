...
During the development of the Beneficial Ownership Data Standard, a [three-stage process](https://github.com/openownership/data-standard/issues/4) was used [to develop narrative use cases](https://docs.google.com/document/d/1s1qqFAK3cDjTGAlCaQvPOb8KzKkssn9xu2HzWeY6amE/edit#heading=h.7683uvve3m45), before these were refined into structured user stories, and then used to generate a set of technical requirements for standard development.
