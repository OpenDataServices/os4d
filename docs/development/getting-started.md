...
- **Developer** - creating and implementing tools for maintaining a [Single Source of Truth](../patterns/documentation.md#single-source-of-truth), managing documentation, performing data validation, and supporting standard adoption.
