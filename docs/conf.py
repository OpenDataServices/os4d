...
# ones.
extensions = ['sphinxcontrib.mermaid', 'myst_parser', 'sphinxcontrib.mermaid', 'sphinx_design']
...
project = 'Open Data Services - Standards Lab Handbook'
...
man_pages = [
    (master_doc, 'sphinx', 'Open Data Services - Standards Lab Handbook',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphinx', 'Open Data Services - Standards Lab Handbook',
     author, 'sphinx', 'Documenting patterns for data standard development.',
     'Miscellaneous'),
]
