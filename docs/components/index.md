...
Whether or not these are important to a particular standard depends on lots of factors, including but not limited to the maturity of the standard, whether the standard’s adoption is being driven cooperatively or adversarially, political factors and the character of the people and organisations in the domain where the standard operates.
