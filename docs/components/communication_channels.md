...
* Blogs: Where a wide audience is sought
* Microblogging: If there is a community of potential adopters who already use a particular microblogging service
* Email lists:
...
* Microblogging: If the time, people or infrastructure required to make regular updates is not available
